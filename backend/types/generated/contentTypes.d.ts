...
export interface ApiBusinessCategoryBusinessCategory
  ...
  attributes: {
    business_details: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiBusinessDetailBusinessDetail
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    business_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::business-category.business-category'
    >;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    review_photos: Schema.Attribute.Media<'images' | 'files', true>;
